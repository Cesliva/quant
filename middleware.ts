...
export const config = {
  matcher: [
     ...
     * - api (API routes)
     * - _next (Next.js internal routes - static files, image optimization, etc.)
     * - next (alternative Next.js paths)
     * - favicon.ico (favicon file)
     * - public files (public folder)
     */
    "/((?!api|_next|next|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|css|js|woff|woff2|ttf|eot)$).*)",
  ],
};
